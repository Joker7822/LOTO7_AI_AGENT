...
- mean actual mass: **0.192465**
- mean log edge vs uniform: **-0.012569**
- mean Brier edge vs uniform: **-0.000979**

## Five-ticket Portfolio
- mean max hits: **2.5167** / precision random **2.4387**
- >=3 round rate: **50.00%** / random **43.82%**
- >=4 round rate: **8.33%** / random **7.03%**
- score: **2.8965** / random **2.7772**
- score delta: **+0.1193** (bootstrap 95% CI -0.1486〜+0.3995)
- round win rate vs random: **50.0%**
